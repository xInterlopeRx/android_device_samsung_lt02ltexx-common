...
LINEEND=" \\"
COUNT=`wc -l ../lt02ltexx-common/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../lt02ltexx-common/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
FIRST=1
...
LINEEND=" \\"
COUNT=`wc -l ../lt02ltexx-common/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../lt02ltexx-common/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
